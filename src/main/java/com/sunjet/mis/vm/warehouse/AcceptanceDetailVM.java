...
import com.sunjet.mis.module.warehouse.service.AcceptanceDetailService;
...
public class AcceptanceDetailVM extends ListVM<AcceptanceDetailEntity> {
    ...
    @Getter
    @Setter
    private AcceptanceDetailEntity acceptanceDetailEntity = AcceptanceDetailEntity.builder().build();
    @Getter
    @Setter
    private Boolean showForm = false;
    @Getter
    @Setter
    private AcceptanceDetailEntity selectedAcceptanceDetail;
    ...
    @Getter
    private List<AcceptanceDetailEntity> importEntities = new ArrayList<>();
    ...
    public void init() {
        ...
        refreshFirstPage(acceptanceDetailEntity);
        getPageList();
    }
    ...
    public void simpleSearch(){
        acceptanceDetailEntity.setBatchNumber(this.getKeyword());
        getPageList();
    }
...
//    @Command
    public void getPageList() {
        this.setPageResult(acceptanceDetailService.getPageList(this.getPageParam()));
    }

    @Command
    @NotifyChange("pageResult")
    public void gotoPageNo(@BindingParam("e") Event event) {
        refreshPage(acceptanceDetailEntity);
        getPageList();
    }
    ...
    protected void openDialog(String id) {
        try {
            ...
            if (StringUtils.isBlank(id)) {
                this.selectedAcceptanceDetail = acceptanceDetailEntity.builder().build();
            } else {
                this.selectedAcceptanceDetail = acceptanceDetailService.findById(id);
            }
            this.showForm = true;
            BindUtils.postNotifyChange(null, null, AcceptanceDetailVM.this, "showForm");
            BindUtils.postNotifyChange(null, null, AcceptanceDetailVM.this, "selectedAcceptanceDetail");
...
//        this.parentOrgs.clear();
        this.selectedAcceptanceDetail = null;
        this.showForm = false;
    ...
    @NotifyChange("*")
    public void submit() {
        acceptanceDetailService.save(this.acceptanceDetailEntity);
        this.selectedAcceptanceDetail = null;
        this.showForm = false;
    ...
    public void confirmDeleteObject(@BindingParam("id") String id){
        ZkUtils.showQuestion("如果此单据已经打开将会被关闭\n是否删除此单据？", "询问", event -> {
            ...
            if (clickedButton == Messagebox.OK) {
                boolean bl = acceptanceDetailService.deleteById(id);
                if(bl==true){
    ...
    public void importData() {
        ...
        this.importEntities = acceptanceDetailService.saveAll(this.importEntities);
...
//                System.out.println(list.toString());
            ...
            importEntities = ExcelUtil.readExcel(path + fileName, AcceptanceDetailEntity.class);
...
////
            ...
            Class<AcceptanceDetailEntity> clazz = AcceptanceDetailEntity.class;
...
//            System.out.println("新文件的编码格式: " + EncodingDetect.getJavaEncodeFile(path + fileName));
    ...
    public String genStyle(AcceptanceDetailEntity entity) {
    ...
    @NotifyChange("*")
    public void reset() {
        this.acceptanceDetailEntity.setVehicleModel("");
        this.acceptanceDetailEntity.setVariety("");
        this.acceptanceDetailEntity.setBatchNumber("");
        this.getPageList();
    }
    ...
    public void downloadTemplate() {
        try {
            byte[] buffer = null;
            String path = ClassUtils.getDefaultClassLoader().getResource("").getPath() + "template/SGMW验收明细.xlsx";
            ...
            Filedownload.save(buffer, null, "SGMW验收明细.xlsx");
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void export(@BindingParam("type") String type) {
        ...
        //当前页
        List<AcceptanceDetailEntity> dataSet = null;
        ...
        for (AcceptanceDetailEntity detailItem : dataSet) {
